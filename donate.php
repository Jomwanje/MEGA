        ...
        <div class="row">
          <div class="col-md-9">
            <header class="single-post-header clearfix">
              <h2 class="post-title">Youth Camp, Mai Mahiu</h2>
            </header>
            <article class="post-content cause-item">
                <span class="post-meta meta-data">
                  <span><i class="fa fa-calendar"></i> 6th Dec, 2021</span>
                  <span><i class="fa fa-archive"></i> <a href="#">Messianic Gospel</a>, <a href="#">Mai mahui</a></span>
                </span>
                	...
                	<div class="col-md-5">
                        <ul class="list-group">
                          <li class="list-group-item">
                      	  ...
                      	  <li class="list-group-item"> <span class="badge">Ksh150,000</span> Amount Needed </li>
                      	  <li class="list-group-item"> <span class="badge">Ksh.16,000</span> Collected yet </li>
                      	 <li class="list-group-item"> <span class="badge">90</span> Days left to achieve target</li>
                        </ul>
                  		<a href="#" class="btn btn-primary btn-lg btn-block donate-paypal" data-toggle="modal" data-target="#PaymentModal">Donate Now</a>
                    </div>
                </div>
                <div class="spacer-30"></div>
                <p>Messianic Gospel Assembly Always Hold Conferences to empower members with Knowledge Necessary for Spiritual Growth</p>
                <p>Members who fees to attend are highly welcomed.No entry fee</p>
            </article>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <p class="small short">If you would prefer to call in your donation, please call 0717065073</p>
                  </div>
                </div>
              </div>
            </div>
