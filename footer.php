    ...
    <div class="container">
      <div class="row"> 
        ...
        <div class="col-md-4 col-sm-4 widget footer-widget">
          <h4 class="footer-widget-title">About MEGA</h4>
          <img src="images/logomain.png" width="120px" alt="Logo">
		  <?php
        ...
        <div class="col-md-4 col-sm-4 widget footer-widget">
          ...
          <ul>
            <li><a href="https://www.facebook.com/messianicgospelassembly">LIVE SERMONS</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="copyrights-col-left col-md-6 col-sm-6">
          <p>&copy; 2021 MEGA. All Rights Reserved</p>
        </div>
